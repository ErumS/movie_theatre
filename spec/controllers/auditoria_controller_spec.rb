  ...
  context 'Success' do
    ...
    context 'POST create' do
      it 'should create a valid auditorium' do
        ...
        post :create, auditorium: { screen_size: Faker::Demographic.height, no_of_seats: Faker::Number.between(1, 200), theatre_id: theatre.id, movie_id: movie.id }, format: 'json'
        response.should have_http_status(:ok)
      end
    end
